...
#sample location: x = -118.442301  y = 34.071667
...
#make a tuple of coordinates
xy = (xCoord,yCoord)

#create a point cursor to add xy point to shapefile copy 
...
#create a single point shapefile based off copy of shapefile
...
inFacilities = folder_path + r'\Results\Nearest Stations.shp'
